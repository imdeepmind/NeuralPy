...
@pytest.mark.parametrize(
    ...
    [
        ...
        (False, 1, 5, "tanh", False, False, 0, False, "test"),
        (345.6, 1, 5, "tanh", False, False, 0, False, "test"),
        ("this", 1, 5, "tanh", False, False, 0, False, "test"),
        # Checking num_layers validation
        (128, -3, 5, "tanh", False, False, 0, False, "test"),
        (128, 43.4, 5, "tanh", False, False, 0, False, "test"),
        (128, False, 5, "tanh", False, False, 0, False, "test"),
        (128, "test", 5, "tanh", False, False, 0, False, "test"),
        # Checking input_size validation
        (128, 1, "test", "tanh", False, False, 0, False, "test"),
        (128, 1, False, "tanh", False, False, 0, False, "test"),
        (128, 1, 5.5, "tanh", False, False, 0, False, "test"),
        (128, 1, -56, "tanh", False, False, 0, False, "test"),
        # Checking non_linearity validation
        (128, 1, 5, "invalid", False, False, 0, False, "test"),
        (128, 1, 5, "test", False, False, 0, False, "test"),
        (128, 1, 5, False, False, False, 0, False, "test"),
        (128, 1, 5, 23, False, False, 0, False, "test"),
        # Checking bias validation
        (128, 1, 5, "tanh", "test", False, 0, False, "test"),
        (128, 1, 5, "tanh", 345, False, 0, False, "test"),
        (128, 1, 5, "tanh", 45.64, False, 0, False, "test"),
        # Checking batch_first
        (128, 1, 5, "tanh", False, "test", 0, False, "test"),
        (128, 1, 5, "tanh", False, 4.53, 0, False, "test"),
        (128, 1, 5, "tanh", False, 23, 0, False, "test"),
        # Checking dropout validation
        (128, 1, 5, "tanh", False, False, "test", False, "test"),
        (128, 1, 5, "tanh", False, False, "", False, "test"),
        (128, 1, 5, "tanh", False, False, 45.43, 234.43, "test"),
        # Checking bidirectional validation
        (128, 1, 5, "tanh", False, False, 0, "test", "test"),
        (128, 1, 5, "tanh", False, False, 0, 234.2, "test"),
        (128, 1, 5, "tanh", False, False, 0, 34, "test"),
        # Checking name validation
        (128, 1, 5, "tanh", False, False, 0, False, False),
        (128, 1, 5, "tanh", False, False, 0, False, ""),
        (128, 1, 5, "tanh", False, False, 0, False, 234),
    ],
)
