...
from neuralpy.layers import AvgPool3D


def test_AvgPool3D_should_throws_type_error():
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((3, 3, 3), "invalid", 3, False, False, False, "test"),
        ((3, 3, 3), ("", 3, 3), 3, False, False, False, "test"),
        ((3, 3, 3), (3, "", 3), 3, False, False, False, "test"),
        ((3, 3, 3), (3, 3, ""), 3, False, False, False, "test"),

        # Checking padding validation
        ((3, 3, 3), (3, 3, 3), "invalid", False, False, False, "test"),
        ((3, 3, 3), (3, 3, 3), ("", 3, 3), False, False, False, "test"),
        ((3, 3, 3), (3, 3, 3), (3, "", 3), False, False, False, "test"),
        ((3, 3, 3), (3, 3, 3), (3, 3, ""), False, False, False, "test"),

        # Checking ceil mode validation
        ((3, 3, 3), (3, 3, 3), (3, 3, 3), "invalid", False, False, "test"),
        ((3, 3, 3), (3, 3, 3), (3, 3, 3), 12.5, False, False, "test"),

        # Checking count_include_pad validation
        ((3, 3, 3), (3, 3, 3), (3, 3, 3), False, "test", False, "test"),
        ((3, 3, 3), (3, 3, 3), (3, 3, 3), False, 23.4, False, "test"),

        # Checking divisor_override validation
        ((3, 3, 3), (3, 3, 3), (3, 3, 3), False, False, "invalid", "test"),
        ((3, 3, 3), (3, 3, 3), (3, 3, 3), False, False, 12.4, "test"),

        # Checking name validation
        ((3, 3, 3), (3, 3, 3), (3, 3, 3), False, False, False, False),
        ((3, 3, 3), (3, 3, 3), (3, 3, 3), False, False, False, 12),
    ]
)
def test_AvgPool3D_throws_value_error(
        kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override, name):
...
def test_AvgPool3D_get_layer_method(
        kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override, name):
    x = AvgPool3D(
        kernel_size=kernel_size, stride=stride,
        padding=padding,
    ...
    layer_details = x.set_input_dim(prev_dim, "conv3d")
    ...
    assert issubclass(details['layer'], _AvgPool3D) == True
