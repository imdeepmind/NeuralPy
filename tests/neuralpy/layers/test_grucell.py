...
from neuralpy.layers import GRUCell
...
def test_GRUCell_should_throw_value_error(
        input_size, hidden_size, bias, name):
...
def test_GRUCell_layer_get_method(
        input_size, hidden_size, bias, name):
    ...
    if input_size is None:
        x.get_input_dim(prev_dim, "GRUCell")
    ...
    assert issubclass(details['layer'], _GRUCell) == True
