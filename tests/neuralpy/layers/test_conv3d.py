...
@pytest.mark.parametrize(
    ...
    [
        ...
        (32, ("", 3, 3), "invalid", "invalid", "invalid", "invalid", "groups", False, ""),
        (32, (3, "", 3), "invalid", "invalid", "invalid", "invalid", "groups", False, ""),
        (32, (3, 3, ""), "invalid", "invalid", "invalid", "invalid", "groups", False, ""),

        # Chaking input shape validation
        (128, (3,3,3), "invalid","invalid", "invalid", "invalid", "groups", False, ""),
        (128, (3,3,3), False, 4.6, "invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3,"", 3, 3), "invalid","invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), ("",3, 3, 3), "invalid","invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3 ,3, "", 3), "invalid","invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3 ,3, 3, ""), "invalid","invalid", "invalid", "groups", False, ""),
        
        # Checking stride validation
        (256, (3,3,3), (3,3,3,3), "invalid","invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), 4.5,"invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), False,"invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), ("",),"invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3.4, 3, 3),"invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3, "", 3),"invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3, 3, ""),"invalid", "invalid", "groups", False, ""),

        # Checking padding validation
        (256, (3,3,3), (3,3,3,3), (3,3,3), "invalid", "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), False, "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), 6.5, "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), ("", 3, 3), "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3, "", 3), "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3, 3, ""), "invalid", "groups", False, ""),

        # Checking the dilation
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), "invalid", "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), False, "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), 4.5, "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), ("", 3, 3), "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), (3, "", 3), "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), (3, 3, ""), "groups", False, ""),

        # Checking the groups
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3), (4,4), "groups", False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3), (4,4), 4.5, False, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3), (4,4), False, False, ""),

        # Checking the bias
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), (4,4,4), 12, 12, ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), (4,4,4), 12, "invalid", ""),
        (256, (3,3,3), (3,3,3,3), (3,3,3), (3,3,3), (4,4,4), 12, .45, ""),
...
def test_Conv3d_should_throw_value_error(filters, kernel_size, input_shape, stride, padding, dilation, groups, bias, name):
    with pytest.raises(ValueError) as ex:
        x = Conv3D(filters=filters, kernel_size=kernel_size, input_shape=input_shape,
...
def test_Conv3d_get_layer_method(_filters, _kernel_size, _input_shape, _stride, _padding, _dilation, _groups, _bias, _name):
    x = Conv3D(filters=_filters, kernel_size=_kernel_size, input_shape=_input_shape,
    ...
    assert issubclass(details["layer"], _Conv3D) == True
