...
class ConvTranspose2d(CustomLayer):
    ...
    def __init__(
        ...
        """
            __init__ method for ConvTranspose2d layer
        ...
        super().__init__(_ConvTranspose2d, "ConvTranspose2d", layer_name=name)
    ...
    def __get_layer_details(self):
        ...
        return(
            self.__input_shape[0], self.__in_channels * dim1 * dim2,
            (self.__in_channels, dim1, dim2)
        )
