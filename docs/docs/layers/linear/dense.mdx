---
title: "Dense Layer"
metaTitle: "Dense Layer | Linear Layers | NeuralPy Deep Learning Library"
metaDescription: "A Dense layer is a densely connected Neural Network layer. It performs a linear transformation of the input."
---
# Dense
