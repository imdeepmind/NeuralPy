...
```python
neuralpy.layers.recurrent.GRU(hidden_size, num_layers=1, input_size=None, bias=True, batch_first=False, dropout=0, bidirectional=False, name=None)
```

:::caution

GRU Layer is unstable and buggy, not ready for any real use
