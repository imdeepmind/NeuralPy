---
title: "LSTM Layer"
metaTitle: "LSTM Layer | Recurrent Layers | NeuralPy Deep Learning Library"
metaDescription: "Applies a multi-layer long short-term memory (LSTM) RNN to an input sequence."
---

# RNN

```python
neuralpy.layers.LSTM(hidden_size, num_layers=1, input_size=None, bias=True, batch_first=False, dropout=0, bidirectional=False, name=None)
```
