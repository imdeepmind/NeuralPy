---
title: "GRUCell Layer"
metaTitle: "GRUCell Layer | Recurrent Layers | NeuralPy Deep Learning Library"
metaDescription: "Applies a gated recurrent unit (GRU) cell"
---

# GRUCell

```python
neuralpy.layers.GRUCell(input_size, hidden_size, bias=True, name=None)
```
