---
title: "RNN Layer"
metaTitle: "RNN Layer | Recurrent Layers | NeuralPy Deep Learning Library"
metaDescription: "Applies a multi-layer Elman RNN with tanh or ReLU non-linearity to an input sequence."
---
