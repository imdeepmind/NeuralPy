---
id: batchnorm3d
title: BatchNorm3D | NeuralPy
sidebar_label: BatchNorm3D
slug: /layers/normalization-layers/batchnorm3d
...
```python
neuralpy.layers.normalization.BatchNorm3D(num_features, eps=1e-05, momentum=0.1, affine=True, track_running_status=True, name=None)
```
