---
id: batchnorm1d
title: BatchNorm1D | NeuralPy
sidebar_label: BatchNorm1D
slug: /layers/normalization-layers/batchnorm1d
...
```python
neuralpy.layers.normalization.BatchNorm1D(num_features, eps=1e-05, momentum=0.1, affine=True, track_running_status=True, name=None)
```
