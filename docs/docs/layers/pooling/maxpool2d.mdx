---
title: "MaxPool2D Layer"
metaTitle: "MaxPool2D Layer | Pooling Layers | NeuralPy Deep Learning Library"
metaDescription: "MaxPool2D Applies a 2D max pooling over an input."
---
# MaxPool2D
