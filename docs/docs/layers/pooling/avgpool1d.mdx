---
title: "AvgPool1D Layer"
metaTitle: "AvgPool1D Layer | Pooling Layers | NeuralPy Deep Learning Library"
metaDescription: "AvgPool1D Applies a 1D avg pooling over an input."
---
# AvgPool1D
