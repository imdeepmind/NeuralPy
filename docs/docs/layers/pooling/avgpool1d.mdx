---
id: avgpool1d
title: AvgPool1D | NeuralPy
sidebar_label: AvgPool1D
slug: /layers/pooling-layers/avgpool1d
...
```python
neuralpy.layers.pooling.AvgPool1D(kernel_size, stride=None, padding=0, ceil_mode=False, count_include_pad=True, name=None)
```

:::info

AvgPool1D Layer is mostly stable and can be used for any project. In the future, any chance of breaking changes is very low.
