---
title: "Conv3D Layer"
metaTitle: "Conv3D Layer | Convolutional Layers | NeuralPy Deep Learning Library"
metaDescription: "Applies a 3D convolution over an input signal composed of several input planes."
---
# Conv3D
