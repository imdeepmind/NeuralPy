---
title: "Conv2D Layer"
metaTitle: "Conv2D Layer | Convolutional Layers | NeuralPy Deep Learning Library"
metaDescription: "Applies a 2D convolution over an input signal composed of several input planes."
---
# Conv2D
